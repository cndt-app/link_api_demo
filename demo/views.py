...
class CompanyInfo(TemplateView):
    ...
    def get_context_data(self, company_id: str, **kwargs):
        ...
        all_integrations = ConduitAPI().get_integrations()

        exist_connections_ids = {i['id'] for i in company['connections']}
        connections = company['connections'] + [i for i in all_integrations if i['id'] not in exist_connections_ids]
